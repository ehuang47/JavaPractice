...
class UserCreateDtoTest {
    ...
    void setUp() {
        ...
        validUser = new UserCreateDto("John Doe", "johndoe", "john.doe@example.com");
    }

    @Test
    void whenAllFieldsValid_thenNoViolations() {
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(validUser);
        assertTrue(violations.isEmpty(), "No violations should be present for a valid user");
    }

    @Test
    void whenNameIsNull_thenOneViolation() {
        UserCreateDto user = new UserCreateDto(null, "johndoe", "john.doe@example.com");
    ...
    void whenNameIsBlank_thenOneViolation() {
        UserCreateDto user = new UserCreateDto(" ", "johndoe", "john.doe@example.com");
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenNameExceedsMaxLength_thenOneViolation() {
        ...
        UserCreateDto user = new UserCreateDto(longName, "johndoe", "john.doe@example.com");
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenUsernameIsNull_thenOneViolation() {
        UserCreateDto user = new UserCreateDto("John Doe", null, "john.doe@example.com");
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenUsernameIsBlank_thenTwoViolations() {
        UserCreateDto user = new UserCreateDto("John Doe", " ", "john.doe@example.com");
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenUsernameTooShort_thenOneViolation(String username) {
        UserCreateDto user = new UserCreateDto("John Doe", username, "john.doe@example.com");
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenUsernameExceedsMaxLength_thenOneViolation() {
        ...
        UserCreateDto user = new UserCreateDto("John Doe", longUsername, "john.doe@example.com");
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenEmailIsNull_thenOneViolation() {
        UserCreateDto user = new UserCreateDto("John Doe", "johndoe", null);
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenEmailIsBlank_thenTwoViolations() {
        UserCreateDto user = new UserCreateDto("John Doe", "johndoe", " ");
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenEmailInvalidFormat_thenOneViolation(String invalidEmail) {
        UserCreateDto user = new UserCreateDto("John Doe", "johndoe", invalidEmail);
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
    ...
    void whenEmailExceedsMaxLength_thenOneViolation() {
        ...
        UserCreateDto user = new UserCreateDto("John Doe", "johndoe", longEmail);
        Set<ConstraintViolation<UserCreateDto>> violations = validator.validate(user);
